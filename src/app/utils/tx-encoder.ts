...
import { TransactionInput, TransactionOutput } from '../app.datatypes';

export class TxEncoder {
  static encode(inputs: TransactionInput[], outputs: TransactionOutput[], signatures: string[], innerHash: string, transactionType = 0) {
  ...
  private static encodeSizeTransaction(inputs: TransactionInput[], outputs: TransactionOutput[], signatures: string[]): BigNumber {
