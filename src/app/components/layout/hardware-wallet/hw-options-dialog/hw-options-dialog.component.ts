...
import { HwWalletService, OperationResults } from '../../../../services/hw-wallet/hw-wallet.service';
import { WalletService, HwFeaturesResponse, HwSecurityWarnings } from '../../../../services/wallet/wallet.service';
...
export class HwOptionsDialogComponent extends HwDialogBaseComponent<HwOptionsDialogComponent> implements OnDestroy {
  ...
  private openDialog(dialogType) {
    ...
    this.currentDialog = this.dialog.open(dialogType, config);

    this.dialogSubscription = this.currentDialog
